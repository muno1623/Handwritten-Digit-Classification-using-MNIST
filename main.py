...
#saving model
model.save("E:/Computer Vision and Machine Learning Projects/BuildingCNN/mnist_simple_cn_2ep.h5")
...
#Prdeiction
#loading model
classifier = load_model("E:/Computer Vision and Machine Learning Projects/BuildingCNN/mnist_simple_cn_2ep.h5")
for i in range (0, 10):
